...
<body class="background-primary">
    ...
    <div class="container-fluid p-0 mt-0 mx-5">
        <div class="row g-0 min-vh-100 ">
            <div class="col-12 col-sm-5 background-color login-card-custom d-flex flex-column justify-content-center p-4 p-sm-5 m-5">
                ...
                <p class="text-center text-secundary mb-4">Preencha os espaços com suas informações.</p>

                <form action="./email.html">

                    <div class="mb-3">
                        <label class="label text-name mx-3" for="">Nome:</label>
                        <input type="text" placeholder="Maria" class="form-control  text-secundary">
                    </div>

                    <div class="mb-3">
                        <label class="label text-name mx-3" for="">Sobrenome:</label>
                        <input type="text" placeholder="Silva" class="form-control text-secundary">
                    </div>

                    <div class="mb-3 ">
                        <label class="label text-name mx-3" for="">Data de Nascimento:</label>
                        <input type="date" placeholder="00/00/0000" class="form-control text-secundary">
                    </div> 

                    <div class="text-center">
                            <button type="submit" class="border btn-perfil border-1 button-gradient mt-3 py-0 px-5 rounded-4 w-50 btn-perfiltext-welcome fs-5 
                            mt-2 pt-1 nunita-bold">
                                Próximo
